        ...
        <div id="header" class="app-header">
            ...
            <div class="menu">
                <div class="menu-search" style="display: flex;">
                    <form action="{{route('dashboard.attendances.start')}}" method="post" accept-charset="utf-8">
                        @csrf
                        <button type="submit" class="btn btn-primary">Start</button>
                    </form>
                   <form action="{{route('dashboard.attendances.finish',Auth::User()->id)}}" method="post" accept-charset="utf-8">
                        @csrf
